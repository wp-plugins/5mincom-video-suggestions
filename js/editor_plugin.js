...
(function() {
	var rootAttributes = tinymce.explode('id,name,width,height,style,align,class,hspace,vspace,bgcolor,type'), excludedAttrs = rootAttributes.join(','), Node = tinymce.html.Node,
	...
	// Register plugin
	tinymce.PluginManager.add('fiveminpagebreak', tinymce.plugins.MediaPlugin);
})();